...
from gymnasium_robotics.envs.mobile_fetch import MujocoMobileFetchEnv, MujocoPyMobileFetchEnv

# Ensure we get the path separator correct on windows
MODEL_XML_PATH = os.path.join("fetch", "slide.xml")


class MujocoPyMobileFetchSlideEnv(MujocoPyMobileFetchEnv, EzPickle):
    def __init__(self, reward_type="sparse", **kwargs):
        ...
        MujocoPyMobileFetchEnv.__init__(
            self,
...
class MujocoFetchMobileSlideEnv(MujocoMobileFetchEnv, EzPickle):
    """
    ## Description
